                        ...
                        <ul class="dropdown-menu">
                            <c:choose>
                                <c:when test="${sessionScope.ADMIN.role.roleID==2}">
                                    ...
                                    <li><a class="dropdown-item" href="/banhang/admin/color-management">Quản lý màu sản phẩm</a></li>
                                ...
                                <c:otherwise>
                                    ...
                                    <li><a class="dropdown-item" href="/banhang/admin/order-management">Quản lý đơn hàng</a></li>
